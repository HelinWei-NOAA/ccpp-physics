...
!!
      subroutine GFS_surface_generic_pre_run (nthreads, im, levs, vfrac, islmsk, isot, ivegsrc, stype,     &
                          scolor,lai,vtype, slope,                                                         &
                          ...
                          wind, u1, v1, cnvwind, smcwlt2, smcref2, vtype_save, stype_save,                 &
                          scolor_save,lai_save, slope_save,                                                &
                          errmsg, errflg)
